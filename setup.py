...
PYPI_NAME = "skill-ovos-ollama-chat"  # pip install PYPI_NAME
URL = f"https://github.com/branep/{PYPI_NAME}"
SKILL_CLAZZ = "OllamaChatSkill"  # needs to match __init__.py class name
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="ovos ollama chat skill",
    ...
    install_requires=get_requirements(path.join(SKILL_PKG, "requirements.txt")),
